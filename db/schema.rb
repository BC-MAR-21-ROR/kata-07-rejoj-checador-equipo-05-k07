...
ActiveRecord::Schema.define(version: 2021_04_14_022915) do
  ...
  create_table "access_points", force: :cascade do |t|
    ...
    t.index ["employee_id"], name: "index_access_points_on_employee_id"
  end
  ...
  add_foreign_key "access_points", "employees"
